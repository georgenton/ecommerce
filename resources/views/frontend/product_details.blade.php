                        ...
                        <div class="product-description-wrapper">
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank"> @if ($refund_sticker != null && $refund_sticker->value != null && $detailedProduct->refundable == 1) <img src="{{ asset($refund_sticker->value) }}" height="36"> @else <img src="{{ asset('frontend/images/refund-sticker.jpg') }}" height="36"> @endif</a>
                                    ...
                                    <div class="fluid-paragraph py-4">
                                        ...
                                        @if(Auth::check())
                                            ...
                                            @foreach ($detailedProduct->orderDetails as $key => $orderDetail)
                                                @if($orderDetail->order->user_id == Auth::user()->id && $orderDetail->delivery_status == 'delivered' && \App\Review::where('user_id', Auth::user()->id)->where('product_id', $detailedProduct->id)->first() == null)
                                                    @php
                                                        $commentable = true;
                                                    @endphp
                                                @endif
