...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($order->save()){
            ...
            if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated && \App\OtpConfiguration::where('type', 'otp_for_order')->first()->activated){
    ...
    public function update_payment_status(Request $request)
    {
        ...
        if($order->payment_status == 'paid' && $order->payment_type == 'cash_on_delivery' && $order->commission_calculated){
